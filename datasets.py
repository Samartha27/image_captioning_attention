...
def show_img_caps(data_idx = 10):
    data_idx = 10
    image_path = data_location+"/Images/"+df['image'].iloc[data_idx]
    ...
    for i in range(data_idx,data_idx+5):
        print("Caption:",df['caption'].iloc[i])
...
class Vocabulary:
    ...
    # @staticmethod  Commented this line and added self to the sub class and self to spacy_eng
